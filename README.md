...
![ICEManager 소개 배너](assets/hero-simple.svg)
...
![ICETALK 메시지에서 필요한 문장을 선택해 일정과 할 일로 정리하는 흐름](assets/01-icetalk-simple.svg)
...
![공문 본문에서 일정과 마감, 안내 메시지를 정리하는 흐름](assets/02-document-simple.svg)
...
![작성 중인 ICETALK 메시지를 선택하고 말투를 골라 다듬은 뒤 반영하는 흐름](assets/03-polish-simple.svg)
...
![DeskCal 바탕화면 달력의 일정과 할 일을 Google Calendar와 Google Tasks에서도 이어서 확인하는 흐름](assets/04-calendar-google-simple.svg)
